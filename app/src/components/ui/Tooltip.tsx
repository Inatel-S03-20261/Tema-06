...
const Tooltip = ({
    ...
    return (
        <span className="group relative inline-flex text-sm font-medium">
            ...
            <span
                className={`pointer-events-none absolute z-50 hidden w-max max-w-56 rounded-lg bg-gray-900 px-3 py-2 text-sm font-normal text-white shadow-lg group-hover:block ${alignClassNames[align]} ${placementClassNames[placement]}`}
            >
                {content}
            </span>
        </span>
