            ...
            <div className="bg-white rounded-2xl shadow-xl w-full max-w-md overflow-hidden m-4">
                ...
                <div className="px-10 pt-12 pb-10 flex flex-col items-center">
                    ...
                    <form className="w-full flex flex-col gap-5">
                        ...
                        <button className="font-orbitron font-bold w-full bg-red-500 hover:bg-red-600 active:scale-95 transition-all text-white tracking-[0.2em] py-3 rounded-full mt-2">
                            ENTRAR
                        </button>
                    </form>
                </div>
